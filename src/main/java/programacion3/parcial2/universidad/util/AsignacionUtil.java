...
public class AsignacionUtil {
    ...
    public static Predicate<AsignacionDto> buscarPorTodo(String codigo, String codigoMateria, String materia, String codigoProfesor, String profesor) {
        ...
        if (profesor != null && !profesor.isEmpty() && !profesor.equals("null")) {
